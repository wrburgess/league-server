...
describe "Group Games Page" do
  ...
  let(:group_game1) { FactoryGirl.create :group_game, group: group, season: AppSettings.app_season, period: 1, regular: true }
  let(:group_game2) { FactoryGirl.create :group_game, group: group, season: AppSettings.app_season, period: 1, regular: true }
  let(:group_game3) { FactoryGirl.create :group_game, group: group, season: AppSettings.app_season, period: 2, regular: true }
  let(:group_game4) { FactoryGirl.create :group_game, group: group, season: AppSettings.app_season, period: 2, regular: true }
  let(:group_game5) { FactoryGirl.create :group_game, group: group, season: AppSettings.app_season, period: 3, regular: true }
  let(:group_game6) { FactoryGirl.create :group_game, group: group, season: AppSettings.app_season, period: 3, regular: true }
  let(:group_game7) { FactoryGirl.create :group_game, group: group, season: AppSettings.app_season, period: 4, regular: true }
  let(:group_game8) { FactoryGirl.create :group_game, group: group, season: AppSettings.app_season, period: 4, regular: true }
